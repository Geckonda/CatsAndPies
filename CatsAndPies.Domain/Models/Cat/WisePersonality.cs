...
namespace CatsAndPies.Domain.Models.Cat
{
    public class WisePersonality : PersonalityBehavior
    {
        ...
        public WisePersonality(IPersonalityDataProvider dataProvider)
        {
            _responses = dataProvider.GetResponses("WisePersonality");
            _greetings = dataProvider.GetGreetings("WisePersonality");
        }
